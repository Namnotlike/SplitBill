        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareToken = table.Column<string>(type: "nvarchar(22)", maxLength: 22, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankBin = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordedByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConfirmedByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpensePayers_ExpenseId_GroupMemberId",
                table: "ExpensePayers",
                columns: new[] { "ExpenseId", "GroupMemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Expenses_GroupId_IsDeleted_OccurredAt",
                table: "Expenses",
                columns: new[] { "GroupId", "IsDeleted", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseSplits_ExpenseId_GroupMemberId",
                table: "ExpenseSplits",
                columns: new[] { "ExpenseId", "GroupMemberId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settlements_GroupId_IsDeleted_Status",
                table: "Settlements",
                columns: new[] { "GroupId", "IsDeleted", "Status" });
